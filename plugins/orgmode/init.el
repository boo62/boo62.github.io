...
(let* ((org-lisp-dir "~/.emacs.d/elpa/org-20160321"))
  (when (file-directory-p org-lisp-dir)
    (add-to-list 'load-path org-lisp-dir)
    (require 'org)
    (require 'ox-html)))

;; Either this or the commented out section below should
;; find and source a recent htmlize. htmlize has some conflicts
;; with pygmentize so org-html-htmlize-output-type is set to nil.
;; Nikola orgmode lacks some features.
(let* ((htmlize-lisp-dir "~/.emacs.d/elpa/htmlize-20130207.1202"))
  (when (file-directory-p htmlize-lisp-dir)
    (add-to-list 'load-path htmlize-lisp-dir)
    (require 'htmlize)))

;; Add path to htmlizer.
;; (require 'package)
